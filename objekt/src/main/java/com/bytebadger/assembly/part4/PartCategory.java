...
public class PartCategory {
    ...
    Collection<IComputerPart> parts = new ArrayList<>();
    ...
    public boolean isDescendantOf(PartCategory partCategory) {
        ...
        if (this == partCategory) return false;
        if (parent.equals(partCategory)) return true;
    ...
    public void addChildCategory(PartCategory partCategory) {
        if (partCategory == null || this.equals(partCategory) || isDescendantOf(partCategory)) {
    ...
    public void removeChildCategory(PartCategory partCategory) {
        if (!children.contains(partCategory)) throw new IllegalArgumentException();
    ...
    public Collection<IComputerPart> getAllParts() {
        Collection<IComputerPart> allParts = new ArrayList<>(parts);
